...
function UpdateEmployee() {
    ...
    const onUpdate = (e) => {
        e.preventDefault();
        axios
            .put("http://localhost:4000/Register/main/" + params.id, {
        ...
        <div className="container-fluid ">
            <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown ">
                                <a class="nav-link dropdown-toggle text-rgb(7, 4, 34)"  id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Category List
                                </a>
                ...
                <div className="form-wrapper bg-body-white">
                    <form className="update" onSubmit={onUpdate}>
